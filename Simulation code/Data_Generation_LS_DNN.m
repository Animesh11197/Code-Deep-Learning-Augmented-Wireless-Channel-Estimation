...
function [Xtraining_Array_RSRP, Ytraining_regression_double_RSRP, Xvalidation_RSRP, Yvalidation_regression_double_RSRP] = Data_Generation_LS_DNN(Training_set_ratio, SNR_Range, Num_of_frame_each_SNR,MaxDopplerShift)
...
Pilot_interval = 7; % pilot symbols interval (time axis)
Pilot_starting_location = 1;
Pilot_location = [(1:3:Num_of_subcarriers)', (2:3:Num_of_subcarriers)'];  %pilot subcarriers within pilot symbol (freq axis)
...
%H_LS_frame_BiLinear = imresize(H_LS, [Num_of_subcarriers, Frame_size]);
