...
tempLayers = [
    imageInputLayer([24 2 2],"Name","imageinput")
    convolution2dLayer([3 3],2,"Name","conv_1","Padding","same")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([3 3],2,"Name","conv_2","Padding","same")
...
tempLayers = [
    convolution2dLayer([3 3],2,"Name","conv_4","Padding","same")
    reluLayer("Name","relu_2")
    convolution2dLayer([3 3],2,"Name","conv_5","Padding","same")];
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = [
    convolution2dLayer([3 3],2,"Name","conv_6","Padding","same")
    reluLayer("Name","relu_3")
    convolution2dLayer([3 3],2,"Name","conv_7","Padding","same")];
lgraph = addLayers(lgraph,tempLayers);
...
tempLayers = [
    convolution2dLayer([3 3],2,"Name","conv_8","Padding","same")
    reluLayer("Name","relu_4")
    convolution2dLayer([3 3],2,"Name","conv_9","Padding","same")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    additionLayer(2,"Name","addition_4")
    convolution2dLayer([3 3],2,"Name","conv_10","Padding","same")];
lgraph = addLayers(lgraph,tempLayers);
